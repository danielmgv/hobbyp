<html>
	<head>
		<title>Listado de unidades didácticas</title>
		...
		<script src="js/udidacticas_consulta.js" type="text/javascript"></script>
	</head>
	...
	<body class="ui-widget-content">    
		<table>
			<tr>
				...
				<td>
					<input type="text" name="Nombre" id="Nombre" class="filtro" >
				</td>
			</tr>
			<tr>
				<td class="etiqueta">
				...
				<td>
					<select name="Asignatura" id="Asignatura" style="width:120px" class="filtro" >
					</select>
				</td>
			</tr>
		</table>
